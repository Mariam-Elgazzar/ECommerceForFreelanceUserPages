...
export class SupportComponent {
  ...
  supportChannels = [
    ...
    },
    {
      ...
      contact: "support@caterpillar-sa.com",
    ...
    },
    {
      ...
      contact: "الرياض، المملكة العربية السعودية",
  ...
  faqCategories = [
    {
      ...
      questions: ["كم يستغرق وقت التوصيل؟", "ما هي تكلفة الشحن؟", "هل يمكنني تتبع طلبي؟"],
    },
    {
      title: "المنتجات والضمان",
      questions: ["ما هي مدة الضمان؟", "كيف أحصل على قطع الغيار؟", "هل المنتجات أصلية؟"],
    },
    {
      title: "الدفع والفواتير",
      questions: ["ما هي طرق الدفع المتاحة؟", "هل يمكنني الدفع بالتقسيط؟", "كيف أحصل على فاتورة؟"],
    },
  ]
